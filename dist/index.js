...
var init_cjs_shim = __esm({
  "src/cjs-shim.ts"() {
    globalThis.require = _module.createRequire.call(void 0, importMetaUrl);
    globalThis.__filename = _url2.default.fileURLToPath(importMetaUrl);
    globalThis.__dirname = _path2.default.dirname(__filename);
  }
});
...
// src/command-help.ts
init_cjs_shim();
var CommandParser = (_class = class _CommandParser {
  ...
  static generateCommandList(commands) {
    ...
    Object.values(commands).forEach((el) => {
      if (_optionalChain([el, 'optionalAccess', _2 => _2.hidden]) === true)
        return;
      cmdlist.push({
        name: el.command,
...
var Command = (_class2 = class {
  ...
  __init4() {this.options = []}
  __init5() {this.subcommands = []}
  __init6() {this.fun = true}
  __init7() {this._arguments = []}
  __init8() {this._options = []}
  __init9() {this._commandStack = []}
  __init10() {this._subcommands = {}}
  __init11() {this._type = "command"}
  /**
   * Command constructor
   * 
  ...
  __init12() {this.out = (msg, opts = {}) => this.log(msg, opts)}
  ...
  __init13() {this.spacer = () => console.log()}
  __init14() {this.rainbow = (text) => rainbow(text)}
  heading(msg, opts = {}) {
